namespace Trezor.Net.Contracts.Stellar
{
    ...
    public class StellarSignTx : ProtoBuf.IExtensible
    {
        ...
        {
            get => __pbn__SequenceNumber.GetValueOrDefault();
        ...
        {
            get => __pbn__TimeboundsStart.GetValueOrDefault();
        ...
        {
            get => __pbn__TimeboundsEnd.GetValueOrDefault();
        ...
        {
            get => __pbn__MemoType.GetValueOrDefault();
        ...
        public ulong MemoId
        {
            get => __pbn__MemoId.GetValueOrDefault();
        ...
        {
            get => __pbn__NumOperations.GetValueOrDefault();
